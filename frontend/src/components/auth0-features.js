...
export const Auth0Features = () => {
  const featuresList = [
    {
      ...
      resourceUrl: "https://xconnections.com/docs/connections",
    ...
    },
    {
      ...
      resourceUrl: "https://xconnections.com/docs/multifactor-authentication",
    ...
    },
    {
      ...
      resourceUrl: "https://xconnections.com/docs/attack-protection",
    ...
    },
    {
      ...
      resourceUrl: "https://xconnections.com/docs/actions",
  ...
  return (
    <div className="auth0-features">
      <h2 className="auth0-features__title">Explore Our Offerings</h2>
